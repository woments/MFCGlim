...
void CMFCGlimDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Text(pDX, IDC_Edit_Radius, Radius_value);
	DDX_Text(pDX, IDC_Edit_Thickness, Thickness_Value);
}
...
BOOL CMFCGlimDlg::OnInitDialog()
{
	...
	MoveWindow(0, 0, 640, 800);
	m_pCGlimImage = new CGlimImage;
	m_pCGlimImage->Create(IDD_CGlimImage,this);
	m_pCGlimImage->ShowWindow(SW_SHOW);
...
void CMFCGlimDlg::OnBnClickedThicknessenter()
{
	UpdateData(TRUE);
	if (m_pCGlimImage) {
		m_pCGlimImage->SetThickness(Thickness_Value);
	}
}
